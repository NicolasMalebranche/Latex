...
Der Ring der symmetrischen Funktionen trägt mehrere Hopfalgebren-Strukturen.
...
und der bekannten Involution als Antipode. Man hat für die Komultiplikation:
...
Außerdem hat man die Adjunktionsformel $\left<x\otimes y, \Delta(z)\right> = \left<x y, z\right>$.
...
$$
ist eine andere Bialgebren-Struktur erklärt.

\bpoint{Faà di Bruno Algebra} \cite{bultel} Auch die Setzung
$$

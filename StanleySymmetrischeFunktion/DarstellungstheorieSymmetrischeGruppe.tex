...
\bpoint{Plethysmen} Es gilt (?): Die Charaktere von $\Schur^\lambda(\Schur^{\mu}V)$ sind als symmetrische Funktionen in den Eigenwerten gleich $\s_\lambda[\s_\mu]$.

...
\begin{proposition} \label{p24}The cup product mapping 
$$H^2(S\hilb{n},\IZ)\otimes H^4(S\hilb{n},\IZ) \rightarrow H^6(S\hilb{n},\IZ) $$ 
is neither injective (unless $n=0$) nor surjective (unless $n\leq 2$). We have:
{\allowdisplaybreaks
\begin{align} 

...
it follows from Propositions \ref{discrOrthPrim} and \ref{squareDiscr} that 
...
$$\frac{\pi_*(H^3(\widetilde{A\times A},\Z)\oplus H^5(\widetilde{A\times A},\Z))}{\pi_*(H^3(\widetilde{A\times A},\Z)^{\mathfrak{S}_2}\oplus H^5(\widetilde{A\times A},\Z)^{\mathfrak{S}_2}}=(\frac{\Z}{2\Z})^{\oplus l_2^3(\widetilde{A\times A})+l_2^5(\widetilde{A\times A})}.$$
...
$$\frac{H^{3}(A^{[2]},\Z)\oplus H^{5}(A^{[2]},\Z)}{\pi_{*}(H^{3}(\widetilde{A\times A},\Z)\oplus H^{5}(\widetilde{A\times A},\Z))}=(\frac{\Z}{2\Z})^{\oplus 4}.$$
However, from the last section, we know that $\pi_{*}(H^{3}(\widetilde{A\times A},\Z))=H^{3}(A^{[2]},\Z)$.
It follows that
$$
\frac{H^{5}(A^{[2]},\Z)}{\pi_{*}(H^{5}(\widetilde{A\times A},\Z))}=(\frac{\Z}{2\Z})^{\oplus 4}.
$$

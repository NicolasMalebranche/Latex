...
$$
Sei $d_n$ die Diskriminante der Bilinearform auf $V$ und $d_{n,k}=\det( G_k)$ diejenige der induzierten Bilinearform, $G_k$ die zugehörige Grammatrix. Dann gilt $$d_{n,k}=(-d_n)^{\binom{n+k-1}{k}}\,a_{n,k}.$$ 

...
\end{align*}
Dann erf\"ullt $p^{m}_n$ die folgende Differentialgleichung:
...
$$ \left<f,g\right> =\int_{S^d} fg ,
$$
die durch einen Gram-Schmidt-Proze\ss , angewandt auf die Monomialbasis in lexikographischer Reihenfolge, entsteht. Es gilt: $\left<h_\alpha,h_\alpha\right> =\left<h_\alpha,x^\alpha\right> $.
\end{document}          

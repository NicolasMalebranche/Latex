...
a_{3,k} = \prod_{\substack{i=-k\ldots k \\ i=k \mod{2}}} (k+1+i)^{\binom{i}{2}} \prod_{i=0}^k (k+1-i)^{i(i+1)}, \\
a_{4,k} = \prod_{i=1}^{k+1} i^{4\binom{i+1}{3}-i\binom{k+1}{1}-2i\binom{k+2}{2} + 3\binom{k+3}{3}}
\end{gather*}

...
\end{proof}
\begin{corollary}\label{thetaCor}
$$
\det(\bra h_\alpha ,h_\beta \ket)_{|\alpha|,|\beta|=k} = \det(\bra x^\alpha ,x^\beta \ket)_{|\alpha|,|\beta|=k} = \theta_{d,k}
$$

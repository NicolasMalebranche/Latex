...
There are two topics that come close. The first one is the theory of Hermite polynomials, see Remark \ref{hermite}. The second is spherical harmonics, which imposes an unwanted restriction though, namely the condition for the polynomials being harmonic.

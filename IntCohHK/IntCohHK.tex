...
$\boldsymbol{\alpha}^{\boldsymbol{\lambda}} \smile
\boldsymbol{\alpha}^{\boldsymbol{\mu}}= \frac{1}{(n-n_1)!\,z_{\lambda^0}}\kq_{n-n_1}(1)Q_1\vac\smile\frac{1}{(n-n_2)!\,z_{\mu^0}}\kq_{n-n_2}(1)Q_2\vac $. 
Thus the coefficient $c^{\boldsymbol{\lambda\mu}}_{\boldsymbol{\nu}}$ in the product expansion is a constant, dependent on $ \left\|\boldsymbol\lambda\right\|,\left\|\boldsymbol\mu\right\|,\left\|\boldsymbol\nu\right\|$, but independent of $n$, multiplied with $\frac{(n-n_3)!}{(n-m)!}$ for a certain $m\leq n_1+n_2$. 
This is a polynomial of degree $m-n_3\leq n_1+n_2-n_3 =\left\|\boldsymbol\lambda\right\|+\left\|\boldsymbol\mu\right\|-\left\|\boldsymbol\nu\right\| $.
\end{proof}
\begin{remark}
The above condition  $n\geq\left\|\boldsymbol\lambda\right\|,\left\|\boldsymbol\mu\right\| $
seems to be unnecessary. This means, that if $n<\left\|\boldsymbol\lambda\right\|$ or $n<\left\|\boldsymbol\nu\right\|$ but $n\geq\left\|\boldsymbol\nu\right\|$, the polynomial $ c^{\boldsymbol{\lambda\mu}}_{\boldsymbol{\nu}}$ is zero at $n$.
\end{remark}

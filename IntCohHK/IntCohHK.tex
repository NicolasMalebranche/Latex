...
\\In the case $n=4$, $ 1^{(4)}$ generates the 2-torsion part and $K+38\cdot1^{(4)}$ generates the 108-torsion part.
\\In the case $n=5$, the last part of the quotient is generated by $K + 16\cdot 1^{(4)} - 21\cdot 1^{(3,2)}$.\\
If $n\geq 6$, the two last parts of the quotient are generated by some multiples of $K -\frac{4}{3}(45-n)1^{(2,2,2)} + (48-n)1^{(3,2)}$, resp. $K-\frac{1}{2}(40-n)1^{(2,2,2)}+ \frac{1}{4}(48-n)1^{(4)}$.
\end{proposition}
\begin{proposition}
$$
...
$$
$$
\frac{H^6(S\hilb{4},\IZ)}{\Sym^3 H^2(S\hilb{4},\IZ)} \cong  \left(\frac{\IZ}{2\IZ} \right)^{\oplus 276} \oplus  \left(\frac{\IZ}{6\IZ} \right)^{\oplus 1748} \oplus  \left(\frac{\IZ}{12\IZ} \right)^{\oplus 253}\oplus  \left(\frac{\IZ}{24\IZ} \right)^{\oplus 23}
$$
$$
\frac{H^6(S\hilb{5},\IZ)}{\Sym^3 H^2(S\hilb{5},\IZ)} \cong   \left(\frac{\IZ}{4\IZ} \right)^{\oplus 22} \oplus  \left(\frac{\IZ}{12\IZ} \right)^{\oplus 254} \oplus  \left(\frac{\IZ}{24\IZ} \right)^{\oplus 2002} \oplus  \left(\frac{\IZ}{120\IZ} \right)^{\oplus 22}
$$
$$
\frac{H^6(S\hilb{n},\IZ)}{\Sym^3 H^2(S\hilb{n},\IZ)} \cong   \left(\frac{\IZ}{24\IZ} \right)^{\oplus 276} \oplus  \left(\frac{\IZ}{120\IZ} \right)^{\oplus 1770}\oplus  \left(\frac{\IZ}{240\IZ} \right)^{\oplus 232} \oplus  \left(\frac{\IZ}{720\IZ} \right)^{\oplus 22} \oplus \IZ^{..}
$$
\end{proposition}

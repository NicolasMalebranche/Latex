...
$p_{\tilde{\nu}}$.
\end{theorem}
Using the algebraic model for computing cup-products in rational cohomology described in \cite{LehnSorger},
...
\begin{proposition}
\begin{align*}
\frac{H^6(S\hilb{4},\IZ)}{H^2(S\hilb{4},\IZ)\cup H^4(S\hilb{4},\IZ)} &\cong \left(\frac{\IZ}{2\IZ}\right)^{\oplus 11} \oplus \left(\frac{\IZ}{6\IZ}\right)^{\oplus 12} \\
\frac{H^6(S\hilb{5},\IZ)}{H^2(S\hilb{5},\IZ)\cup H^4(S\hilb{5},\IZ)} &\cong \left(\frac{\IZ}{2\IZ}\right)^{\oplus 11} \oplus \left(\frac{\IZ}{6\IZ}\right)^{\oplus 9} \oplus \left(\frac{\IZ}{30\IZ}\right)^{\oplus 3} \\
\frac{H^6(S\hilb{6},\IZ)}{H^2(S\hilb{6},\IZ)\cup H^4(S\hilb{6},\IZ)} &\cong \left(\frac{\IZ}{2\IZ}\right)^{\oplus 11} \oplus \left(\frac{\IZ}{6\IZ}\right)^{\oplus 10} \oplus \left(\frac{\IZ}{30\IZ}\right)^{\oplus 2}\oplus \IZ
\end{align*}

...
The classes from Theorem \ref{QinWangTheorem} are represented in the same format. The multiplication in $H^*(S\hilb{n},\IZ)$ of such classes is implemented by the method \verb|cupInt|.
